...
Node* insertRec(Node* subroot, const T &val){
    ...
    //stactic_cast dung de chuyen doi tu T(int) thanh enum BalanceValue de ko bi loi
    subroot->balance = static_cast<BalanceValue>(getHeightRec(subroot->pLeft) - getHeightRec(subroot->pRight));
